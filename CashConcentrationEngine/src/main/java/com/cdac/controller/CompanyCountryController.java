...
public class CompanyCountryController {
	...
	// GetMapping use to fetch all the data from database based on state value pass as path variable.
	...
	// GetMapping use to fetch the profit from database based on the state and month passed.
